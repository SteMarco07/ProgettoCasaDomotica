        ...
        public static void stampaMenu(int scelta_menu){
            ...
            switch(scelta_menu){
                case 0:
                    ...
                    5: Spegni tutte le lampadien del sistema domotico \s
                                            ...
                                            switch (scelta) {
                                                ...
                                                case 2:
                                                    ...
                                                    try {
                                                        ...
                                                        System.out.println("Non è stato possibile eliminare la presa " + nome + " perchè non esiste o il nome non è stato scritto correttamente");
                                                    }
                                                    break;
                                                case 3:
                                            ...
                                            switch (scelta) {
                                                ...
                                                case 2:
                                                    ...
                                                    try {
                                                        ...
                                                        System.out.println("Non è stato possibile eliminare la lampadina " + nomeLampadina + " perchè non esiste o il nome non è stato scritto correttamente");
                                                    }
                                                    break;
                                                case 3:
                                                    if (sistemaDomotico.getNumLampadineStanza(nomeStanza) != 0) {
                                                            ...
                                                            while (scelta != -1) {
                                                                ...
                                                                switch (scelta) {
                                                                    ...
                                                                    case 7:
                                                                        ...
                                                                        System.out.println("La lumisosità della lampadina " + nomeLampadina + " è stata incrementata");
                                                                        break;
                                                                    case 8:
                                                                        sistemaDomotico.diminuisciLumLampadina(nomeStanza, nomeLampadina);
                                                                        System.out.println("La lumisosità della lampadina " + nomeLampadina + " è stata decrementata");
                                                                        break;
                                                                    case 9:
                                                        ...
                                                        System.out.println("Non sono pressenti lapmadine su cui lavorare");
                                                    }
                                                    break;
                                                default:
                                                    System.out.println("Opzione non valida");
